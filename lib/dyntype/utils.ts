...
import { stringTypeInfo } from '../../src/glue/packType.js';
...
export const dyntype_context_init_with_opt = 'dyntype_context_init_with_opt';
...
export const dyntype_new_object_with_proto = 'dyntype_new_object_with_proto';
